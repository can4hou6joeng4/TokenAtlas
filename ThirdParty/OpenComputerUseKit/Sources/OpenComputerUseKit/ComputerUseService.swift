...
public final class ComputerUseService {
    ...
    private let snapshotConfiguration: ComputerUseSnapshotConfiguration

    public init(snapshotConfiguration: ComputerUseSnapshotConfiguration = .default) {
    ...
    public func appSnapshot(app query: String) throws -> AppSnapshot {
    ...
    private func refreshSnapshot(for query: String) throws -> AppSnapshot {
        ...
        let snapshot = try SnapshotBuilder.build(for: app, configuration: snapshotConfiguration)
